    ...
    return (
        <div className='napra3-about-container'>
            ...
            <div className='napra3-about-container_services-container'>
                <div id='napra3-about-container_services-container_service-card-1' className='napra3-about-container_services-container_service-card'>
                ...
                <div id='napra3-about-container_services-container_service-card-2' className='napra3-about-container_services-container_service-card'>
                    <div className='napra3-about-container_services-container_service-card_shade'>
                        <h3>Massage </h3>
                        {/*
                ...
                <div id='napra3-about-container_services-container_service-card-3' className='napra3-about-container_services-container_service-card'>
                    <div className='napra3-about-container_services-container_service-card_shade'>
            ...
            <div className='napra3-about-container_desc-carousel-container'>
                <div className='napra3-about-container_desc-container'>
                    <h1 className='napra3-about-container_desc-container_title'>Naprapat & Rehabcenter Haninge</h1>
                    <p className='napra3-about-container_desc-container_text'>Naprapatklinik i Haninge, 2 mil söder om Stockholm.</p>
                    <p className='napra3-about-container_desc-container_text'>Drivs och ägs idag av tre legitimerade naprapater Line Jonasson (0704540923), Sofie Schmidt (0702443473) och Susanne Nyström (0704530288).</p>
                    <p className='napra3-about-container_desc-container_text'>Hos oss kan du betala med swish, kort, presentkort. </p>
                    <p className='napra3-about-container_desc-container_text'>Vi är även anslutna till friskvårdsportalerna Wellnet, Actiway och Min Friskvård (friskvårdskuponger) samt försäkringsbolagsförmedlare: Falck Healthcare (DKV hälsa, SEB), Nordic Netcare (IF) och SOS International.</p>
                </div>
