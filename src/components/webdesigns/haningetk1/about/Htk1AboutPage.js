    ...
    return (
        <div className='htk1-about-container'>
            ...
            <div className='htk1-about-container_desc-container'>
                ...
                <p>Vill du bli medlem i Haninge TK? Klicka då här!</p>
                <p>För att anmäla dig till tennisskolan eller vuxentennis, klicka då här!</p>
            </div>
        </div>
    )
}

export default Htk1AboutPage